...
@Entity
@DiscriminatorValue("PurSangArabe")
public class PurSangArabe extends Cheval implements Serializable {
	...
	@Transient
	private final static Double COEFF_POIDS = 0.15;
	@Transient
	private final static Double COEFF_VITESSE = 0.25;
	@Transient
	private final static Double COEFF_ENDURANCE = 0.35;
	@Transient
	...
	public PurSangArabe(String nom, String robe) {
		super(nom, robe);
		calcAttributes();
	}
